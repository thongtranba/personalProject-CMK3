			...
			<div class="row">
				<div class="col-xs-9">
					<ol class="breadcrumb">
						...
						<li><span>/</span></li>
						<li class="active"><span>Bags</span></li>
					</ol>
				</div>
				...
				<aside class="col-md-3">
					<div class="inner-aside">
						...
						<div class="category">
							<h5>Size</h5>
							<ul>
								<li class="active"><a href="#" title="1 compartment"
									target="_self">1 compartment </a></li>
								<li class=""><a href="#" title="2 compartments"
									target="_self">2 compartments</a></li>
								<li class=""><a href="#" title="3 compartments"
									target="_self">3 compartments</a></li>
								<li class=""><a href="#" title="backpack" target="_self">Backpack</a>
								</li>
							</ul>
						</div>
						<div class="category">
				...
				<div class="col-md-9 products">
					<div class="row equal">
						...
						<div class="clearfix"></div>
						<c:forEach var="bag" items="${listBags}">
							<div class="col-xs-6 col-sm-4">
								<div class="product-container">
									<div class="image">
										<img class="img-responsive" src="${bag.image}" alt="" />
									</div>
									<div class="product-meta">
										<h5 class="name">
											<a class="product-name"
												href="productDetail?id=<c:out value='${bag.id}' />"
												title="${bag.name}">${bag.name}</a>
										</h5>
										<div class="product-item-price">
											<span class="product-item-regular">${bag.price} euro</span> <span

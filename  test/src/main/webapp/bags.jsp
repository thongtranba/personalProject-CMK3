          ...
          <aside class="col-md-3">
            <div class="inner-aside">
              <div class="category">
                ...
                <ul>
                  <li class="active">
                    <a href="#" title="Women" target="_self">Women </a>
                  </li>
                  <li class="">
                    <a href="#" title="Men" target="_self">Men</a>
                  </li>
                  <li class="">
                    <a href="#" title="Kid" target="_self">Kid</a>
                  </li>
                </ul>
              </div>
              <div class="category">
                ...
                <ul>
                  <li class="active">
                    <a href="#" title="1 compartment" target="_self"
                      >1 compartment
                    </a>
                  </li>
                  <li class="">
                    <a href="#" title="2 compartments" target="_self"
                      >2 compartments</a
                    >
                  </li>
                  <li class="">
                    <a href="#" title="3 compartments" target="_self"
                      >3 compartments</a
                    >
                  </li>
                  <li class="">
                    <a href="#" title="backpack" target="_self">Backpack</a>
                  </li>
                </ul>
              </div>
              <div class="category">
                ...
                <div class="product-container">
                  ...
                  <div class="product-meta">
                    ...
                    <div class="product-item-price">
                      <span class="product-item-regular">${bag.price} euro</span>

          ...
          <aside class="col-md-3">
            <div class="inner-aside">
              ...
              <div class="category">
                ...
                <ul>
                  <li class="active">
                    <a href="#" title="36" target="_self">36 </a>
                  </li>
                  <li class="">
                    <a href="#" title="36.5" target="_self">36.5</a>
                  </li>
                  <li class="">
                    <a href="#" title="40" target="_self">40</a>
                  </li>
                  <li class="">
                    <a href="#" title="41" target="_self">41</a>
                  </li>
                  <li class="">
                    <a href="#" title="42" target="_self">42</a>
                  </li>
                  <li class="">
                    <a href="#" title="44" target="_self">44</a>
                  </li>
                </ul>
              </div>
              <div class="category">
                ...
                <div class="product-container">
                  ...
                  <div class="product-meta">
                    <h5 class="name">
                      <a
                        class="product-name"
                        href="productDetail?id=<c:out value='${shoes.id}' />"
                        title="${shoes.name}"
                        >${shoes.name}</a
                      >
                    </h5>
                    <div class="product-item-price">
                      <span class="product-item-regular">${shoes.price} euro</span>

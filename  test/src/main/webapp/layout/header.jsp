			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-10 col-xs-11 top-right">
					<ul class="list-inline pull-right">
						<li class="account-login"><a href="javascript:void(0)"
							class="btn-register">Register</a></li>
						<li><a href="javascript:void(0)" class="btn-login">Login</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="cart"><a href="javascript:void(0)"
					class="btn-cart-detail" title="Cart"><i
						...
						class="number-total-product">2</span></a></li>
			</ul>
		</div>
	</nav>
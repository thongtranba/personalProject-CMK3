				...
				<div class="row">
					<div class="col-xs-9">
						<ol class="breadcrumb">
							...
							<li><span>/</span></li>
							<li class="active"><span><c:out value="${product.name}" /></span></li>
						</ol>
					</div>
					...
					<div class="col-md-10 product-detail">
						<div class="row product-info">
							...
							<div class="col-md-4">
								<h5 class="product-name"><c:out value="${product.name}" /></h5>
								<div class="brand">
									<span>Brand: </span><c:out value="${product.brandName}" /><span></span>
								</div>
								<div class="product-status">
									<span>Status: </span> <span class="label-warning"><c:out value="${product.inventory_quantity}" /></span>
								</div>
								<div class="product-item-price">
									<span>Price: </span> <span class="product-item-regular"></span> <c:out value="${product.price}" /><span class="product-item-discount">240 eur</span>
								</div>
							</div>
						</div>
								...
								<div role="tabpanel">
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation"><a href="#product-comment"
											aria-controls="tab" role="tab" data-toggle="tab">Comment</a>
										</li>
									</ul>
									<!-- Tab panes -->
				...
				<div class="owl-carousel owl-theme">
					<div class="item thumbnail">
						<div class="product-container">
							...
							<div class="product-meta">
								<h5 class="name">
									<a class="product-name" href="#" title="Lining racket backpack">Lining
										racket backpack</a>
								</h5>
								<div class="product-item-price">
					...
					<div class="item thumbnail">
						<div class="product-container">
							...
							<div class="product-meta">
								<h5 class="name">
									<a class="product-name" href="#" title="Yonex astrox 99 tour">Yonex
										astrox 99 tour</a>
								</h5>
								<div class="product-item-price">
									<span class="product-item-regular">120 euro</span> <span
					...
					<div class="item thumbnail">
						<div class="product-container">
							...
							<div class="product-meta">
								<h5 class="name">
									<a class="product-name" href="#" title="Yonex astrox 88D Pro">Yonex
										astrox 88D Pro</a>
								</h5>
								<div class="product-item-price">
									<span class="product-item-regular">120 euro</span> <span

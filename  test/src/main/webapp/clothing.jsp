          ...
          <aside class="col-md-3">
            <div class="inner-aside">
              ...
              <div class="category">
                ...
                <ul>
                  <li class="active">
                    <a href="#" title="XS" target="_self">XS </a>
                  </li>
                  <li class="">
                    <a href="#" title="S" target="_self">S</a>
                  </li>
                  <li class="">
                    <a href="#" title="M" target="_self">M</a>
                  </li>
                  <li class="">
                    <a href="#" title="L" target="_self">L</a>
                  </li>
                  <li class="">
                    <a href="#" title="XL" target="_self">XL</a>
                  </li>
                  <li class="">
                    <a href="#" title="XXL" target="_self">XXL</a>
                  </li>
                </ul>
              </div>
              <div class="category">
              ...
              <div class="col-xs-6 col-sm-4">
                <div class="product-container">
                  ...
                  <div class="product-meta">
                    <h5 class="name">
                      <a class="product-name" href="productDetail?id=<c:out value='${cloth.id}' />" title="${cloth.name}"
                        >${cloth.name}</a
                      >
                    </h5>
